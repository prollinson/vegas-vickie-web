    ...
    <>
      ...
      <div className="col-span-12 border-t border-[#130E04]">
        <div className="max-w-5xl mx-auto px-4 sm:px-6  lg:px-8 md:flex md:space-x-24 md:flex-row-reverse">
          <div className='w-1/2 mx-auto md:w-1/3 flex flex-wrap grow-0 justify-center content-center'>
            ...
            <img src={borbayArtwork4} alt="BORBAY Artwork" className="w-1/2 aspect-square border-2 border-transparent"/>
            <img src={borbayArtwork5} alt="BORBAY Artwork" className="w-1/2 aspect-square border-2 border-transparent"/>
          </div>
